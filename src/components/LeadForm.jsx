      ...
      <div className="max-w-xl mx-auto py-24 px-6 text-center animate-in fade-in zoom-in duration-700">
        <div className="bg-white px-4 py-10 rounded-[3rem] shadow-2xl border-t-8 border-green-600 relative overflow-hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-green-50 py-6 rounded-3xl border border-green-100">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="flex items-center justify-center gap-3 w-full py-5 px-3 mt-7 bg-[#25D366] text-white font-black text-sm rounded-2xl shadow-xl hover:bg-[#128C7E] transition-all transform hover:-translate-y-1 pulse-animation"
              >
