...
const LeadForm = () => {
  ...
  if (status === 'success') {
    ...
    const pdfUrl = "https://jkiapkmsrkiopkjmzxtx.supabase.co/storage/v1/object/public/Ginger%20farming%20material/Nendang_Shallom_Goshit_Frontend_Developer.pdf?download=";
